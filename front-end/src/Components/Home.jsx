...
const Home = () => {
  ...
  const heroFeatures = [
    {
      ...
      description:
        "Explore our comprehensive library of exercises with detailed instructions, animations, and tips to perfect your form.",
      link: "/exercises",
    ...
    },
    {
      ...
      description:
        "Target specific muscle groups with specialized exercises designed to maximize your gains and improve muscle definition.",
      link: "/muscle",
      color: "from-indigo-600 to-indigo-400",
    },
    {
      image:
        "https://images.unsplash.com/photo-1490645935967-10de6ba17061?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1753&q=80",
      icon: Brain,
      title: "AI Diet Plans",
      description:
        "Get personalized nutrition recommendations powered by AI that adapt to your fitness goals, preferences, and dietary restrictions.",
      link: "/diet",
    ...
    },
    {
      ...
      description:
        "Discover fitness centers in your area with real-time availability, ratings, and special offers to kickstart your fitness journey.",
      link: "/nearby-gyms",
      color: "from-purple-600 to-indigo-400",
      isNew: true,
    },
    {
      image:
        "https://images.unsplash.com/photo-1584735935682-2f2b69dff9d2?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1740&q=80",
      icon: Calendar,
      title: "My Workout Plans",
      description:
        "Access and manage your personalized workout routines, track your progress, and adjust your plans as you grow stronger.",
      link: "/my-plans",
      color: "from-orange-500 to-amber-400",
    },
    {
      image:
        "https://images.unsplash.com/photo-1581009146145-b5ef050c2e1e?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTF8fGd5bXxlbnwwfHwwfHx8MA%3D%3D",
      icon: Plus,
      title: "Create Custom Plans",
      description:
        "Design your own personalized workout routines with our intuitive plan builder. Mix and match exercises for optimal results.",
      link: "/create-plan",
      color: "from-red-500 to-pink-400",
    },
    {
      image:
        "https://images.unsplash.com/photo-1599058917212-d750089bc07e?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1740&q=80",
      icon: BookOpen,
      title: "Workout Plans",
      description:
        "Discover professionally designed workout plans for every fitness level, from beginners to advanced athletes.",
      link: "/plans",
      ...
      autoPlayTimerRef.current = setInterval(() => {
        if (!isHovering) {
          setActiveFeature((prev) =>
            prev === heroFeatures.length - 1 ? 0 : prev + 1
          );
        }
  ...
  const prevFeature = () => {
    // Don't stop auto-play when manually navigating
    setActiveFeature((prev) =>
      prev === 0 ? heroFeatures.length - 1 : prev - 1
    );
  };
            ...
            >
              <div className="space-y-2 sm:space-y-8">
                ...
                <p className="max-w-xl text-xs leading-tight text-center text-gray-600 sm:text-start sm:text-base">
                  Explore customized exercises for your fitness level. Track
                  progress, stay motivated, and build a stronger, healthier you.
                </p>
              </div>
          ...
          <div className="container px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div className="mb-10 text-center">
              ...
              <p className="mx-auto mt-4 max-w-2xl text-gray-600">
                Discover personalized workout plans, targeted exercises, and
                convenient locations to achieve your fitness goals.
              </p>
            </div>
              ...
              <div className="overflow-hidden relative rounded-xl shadow-md transition-all duration-300 hover:shadow-lg group">
                ...
                <div className="flex absolute inset-0 flex-col justify-end p-6 text-white bg-gradient-to-t to-transparent from-black/80">
                  ...
                  <div className="mt-auto">
                    <Link
                      to="/muscle"
                      className="inline-flex items-center px-4 py-2 font-medium text-white bg-purple-600 rounded-lg transition-colors hover:bg-purple-700"
                    >
                      Explore Muscles
                      <svg
              ...
              <div className="overflow-hidden relative rounded-xl shadow-md transition-all duration-300 hover:shadow-lg group">
                ...
                <div className="flex absolute inset-0 flex-col justify-end p-6 text-white bg-gradient-to-t to-transparent from-black/80">
                  ...
                  <div className="mt-auto">
                    <Link
                      to="/plans"
                      className="inline-flex items-center px-4 py-2 font-medium text-white bg-indigo-600 rounded-lg transition-colors hover:bg-indigo-700"
                    >
                      View Plans
                      <svg
                        className="ml-2 w-4 h-4"
              ...
              <div className="overflow-hidden relative rounded-xl shadow-md transition-all duration-300 hover:shadow-lg group">
                ...
                <div className="flex absolute inset-0 flex-col justify-end p-6 text-white bg-gradient-to-t to-transparent from-black/80">
                  ...
                  <div className="mt-auto">
                    <Link
                      to="/nearby-gyms"
                      className="inline-flex items-center px-4 py-2 font-medium text-white bg-blue-600 rounded-lg transition-colors hover:bg-blue-700"
                    >
                      Find Gyms
                      <svg
                        className="ml-2 w-4 h-4"
                  ...
                  <div className="flex absolute inset-0 z-20 justify-center items-center">
                    <div className="px-4 py-8 w-full max-w-4xl text-center sm:px-6 sm:py-12">
                      <AnimatePresence mode="wait">
                        ...
                        >
                          <div
                            className={`p-3 sm:p-4 rounded-full bg-gradient-to-br ${heroFeatures[activeFeature].color} shadow-lg mb-4 sm:mb-6`}
                          >
                            {React.createElement(
                              heroFeatures[activeFeature].icon,
                              {
                          ...
                          <div className="flex gap-2 items-center mb-2 sm:gap-3 sm:mb-4">
                            <h3 className="text-xl font-bold text-white sm:text-3xl md:text-4xl">
      ...
      <section className="py-24 sm:px-16 lg:px-32">
        <motion.div className="mb-16 text-center" {...fadeInUp}>
          ...
          <p className="px-2 mx-auto mt-2 max-w-2xl text-xs text-gray-600 sm:mt-6 sm:text-base">
            Join thousands of users who have already transformed their bodies
            and lives with our personalized workout plans and nutrition
            guidance.
          </p>
        </motion.div>
      ...
      <footer className="px-6 py-16 text-white bg-gray-900 sm:px-16 lg:px-32">
        <div className="container mx-auto">
          <div className="grid grid-cols-1 gap-12 md:grid-cols-2 xl:grid-cols-4">
            <div>
              <div className="flex gap-4 items-center mb-4">
                ...
                <h1 className="text-3xl font-bold">EleFit</h1>
              </div>
              <p className="mb-4 text-gray-400">
                Your personal guide to fitness excellence
              </p>
              <p className="text-gray-400">Created by Maximus-Abhi</p>
            </div>
          ...
          <div className="pt-8 mt-12 text-center text-gray-400 border-t border-gray-800">
            © 2025 EleFit. All rights reserved.
          </div>
        </div>
      </footer>
