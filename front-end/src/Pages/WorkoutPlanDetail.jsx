      ...
      if (error.response?.status === 401 || error.response?.status === 403) {
        ...
        setError(
          error.response?.data?.message ||
            "Failed to load the workout plan. Please try again later."
        );
      }
    } finally {
      setLoading(false);
      ...
      <div className="relative bg-gradient-to-r from-blue-600 to-blue-400 text-white">
        ...
        <div className="container mx-auto px-4 py-8 sm:py-12 relative z-10">
          <div className="mb-4">
            ...
            >
              <ArrowLeft className="h-4 sm:h-5 sm:w-5 mr-1" />
          ...
          >
            ...
            {plan.description && (
              <p className="text-base sm:text-xl opacity-90 mb-4 sm:mb-6 max-w-3xl">
                {plan.description}
              </p>
            )}
